...
_COLOR_RULES = (
    (("NERO", "BLACK", "NOIR"), ("ブラック", "ブラック")),
    (("BIANCO", "WHITE", "OFF-WHITE", "OFFWHITE", "AVORIO", "IVORY", "PANNA"), ("ホワイト", "ホワイト")),
    (("GRIGIO", "GREY", "GRAY", "ANTRACITE"), ("グレー", "グレー")),
    (("BEIGE", "SABBIA", "CREMA", "CAMMELLO", "CAMEL", "TAUPE", "ECRU"), ("ベージュ", "ベージュ")),
    (("MARRONE", "BROWN", "CIOCCOLATO", "MORO", "CUOIO", "TABACCO", "COGNAC"), ("ブラウン", "ブラウン")),
    (("NAVY", "BLU SCURO", "INDACO"), ("ネイビー", "ネイビー")),
    (("BLU", "BLUE", "COBALTO", "AZZURRO", "CELESTE", "DENIM"), ("ブルー", "ブルー")),
    (("VERDE", "GREEN", "MILITARE", "KHAKI", "KAKI", "OLIVA", "SALVIA"), ("グリーン", "グリーン")),
    (("ROSSO", "RED", "BORDEAUX", "BURGUNDY", "VINACCIA"), ("レッド", "レッド")),
